...
`ckanext-dquality` เป็นส่วนขยาย (Extension) สำหรับแพลตฟอร์ม **CKAN** ที่พัฒนาขึ้นเพื่อรองรับการตรวจสอบและประเมินคุณภาพข้อมูล (Data Quality)  
โดยสามารถตรวจสอบได้ทั้งในระดับ **ชุดข้อมูล (Package)** และระดับ **ไฟล์ทรัพยากร (Resource)**

ระบบถูกออกแบบให้สอดคล้องกับการใช้งานแพลตฟอร์ม Open Data ภาครัฐ  
พร้อมสนับสนุนการบริหารจัดการ การติดตาม และการรายงานผลคุณภาพข้อมูลอย่างเป็นระบบ

## ✨ Features

- ตรวจสอบคุณภาพข้อมูลทั้ง 2 ระดับ
  - 📦 ชุดข้อมูล (Package)
  - 📁 ไฟล์ทรัพยากร (Resource)
- รองรับมิติคุณภาพข้อมูล (Data Quality Dimensions) เช่น
  ...
  - ความสอดคล้อง (Data Consistency)
  - ความสามารถในการเข้าถึงข้อมูล (Data Availability)
  - ความทันสมัยของข้อมูล (Timeliness)
  - ข้อมูลตรงตามความต้องการ (Relevancy)
  - ความเป็นเอกลักษณ์ของข้อมูล (Data Uniqueness)
- รองรับการสั่งรันตรวจสอบคุณภาพข้อมูลผ่าน
  - หน้าจอผู้ใช้งาน (UI)
  - คำสั่งผ่าน Command Line Interface (CLI)
- การประมวลผลทำงานในรูปแบบ **Background Job (RQ / ckan.lib.jobs)**
- แสดงผลการตรวจสอบคุณภาพข้อมูลผ่าน
  - Dashboard แสดงผลเชิงสถิติ
  - รายงานผลการตรวจสอบคุณภาพข้อมูล
- มีหน้า **Admin Interface**
  - สำหรับสั่งรันงานตรวจสอบ
  - ตรวจสอบสถานะของ Job ที่กำลังประมวลผล
  - จัดการเวอร์ชั่นผลการตรวจสอบคุณภาพข้อมูล
...
### Extensions ที่แนะนำให้ติดตั้งร่วม
  - `ckanext-scheming` (กรณีมีการใช้ schema เพิ่ม)
  - `ckanext-harvest` (กรณีมีการดึงข้อมูลจากแหล่งภายนอก)
